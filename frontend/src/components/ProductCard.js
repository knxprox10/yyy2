    ...
    <StyledWrapper>
      <div className="card">
            ...
            <div className="colors">
              <ul className="colors-container">
                ...
                <li className="payment-card mastercard" aria-label="Mastercard">
                  <svg viewBox="0 0 40 24" className="card-icon real-icon mastercard" role="img" aria-label="Mastercard">
        ...
        <div className="button-container">
          <button className="buy-button button" onClick={() => setIsOnline(prev => !prev)}>Buy Now</button>
...
const StyledWrapper = styled.div`
  ...
  .card .image-container .status-dot {
    position: absolute;
    top: 6px;
    left: 26px; /* move away from favorite icon to avoid overlap */
    width: 10px;
    height: 10px;
    border-radius: 50%;
